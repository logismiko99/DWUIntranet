...
{
    public partial class studentaffairs : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {

            (Page.Master.FindControl("activestudentaffair") as HtmlControl).Attributes.Add("class", "active");
            (Page.Master.FindControl("Label1") as Label).Text = "DWU Student Affairs";
